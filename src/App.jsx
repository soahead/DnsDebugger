              ...
              <div className="bl-actions">
                ...
                {r.listed === true && r.delistUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    title={"Request delisting from " + r.name}
                  >
                    Delist ↗
                  </a>
                )}
...
export default function App() {
  ...
  async function handleScan() {
    ...
    try {
      ...
      setProgress(100);
      setResult({ domain: d, records, flags, prop, critical, warnings, total, spfVal, dmarcVal });
    } catch(e) {
